      ...
      <div className="min-h-screen flex flex-col lg:flex-row items-center justify-center mt-[-100px] px-10 sm:px-10 lg:px-20 py-10 gap-10">
        ...
        <div className="lg:w-1/2 max-w-md w-full bg-white rounded-xl shadow-xl p-6 sm:p-8">
          <form onSubmit={handleSubmit}>
            ...
            <input type="text" id="nombre" name="nombre" required className="w-full p-3 mb-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-400" />

            <label htmlFor="dni" className="block mb-2 font-bold text-gray-800">DNI:</label>
            <input type="text" id="dni" name="dni" required pattern="\d{7,8}" maxLength="8" className="w-full p-3 mb-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-400" />

            <label htmlFor="email" className="block mb-2 font-bold text-gray-800">Gmail:</label>
            <input type="email" id="email" name="email" required className="w-full p-3 mb-6 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-400" />
