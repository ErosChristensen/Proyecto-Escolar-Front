        ...
        <div className="bg-white shadow-xl rounded-2xl p-4 sm:p-6 w-full max-w-5xl border-4 border-orange-400 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-6 mb-4 sm:mb-6">
            <button
              ...
              className={`${botonPrincipalBase} ${mostrarProgramacion
            ...
            <button
              ...
              className={`${botonPrincipalBase} ${mostrarElectro
                ? "bg-orange-400 text-white border-orange-400"
                : "text-black border-orange-400 hover:bg-orange-400 hover:text-white"
              }`}
            >
          ...
          <div className="text-center text-md text-gray-500">
            Recuerde que los datos cargados en esta sección representan a la institución. 
            Verifique su exactitud antes de publicar. Todo lo que se publique será visible para la comunidad educativa.
          </div>
